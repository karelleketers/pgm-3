...
// sound.frequency.value = 5000;
// sound.start();
// volume.gain.value = 0;
// sound.connect(volume).connect(audioContext.destination);
...
const app = {
  ...
  stopMusic() {
    ...
    // this.$audioEl.pause(); // pauzeren
    // this.$audioEl.currentTime = 0; // terug starten op positie 0 in tijdslijn
    // audio.disconnect();
  },
};
